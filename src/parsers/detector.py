...
class FormatDetector:
    ...
    def _score_patterns(self, lines: List[str], patterns: List[Tuple], 
                       min_matches: int = 1) -> Tuple[float, List[str]]:
        """
    ...
    def _get_hierarchy_levels(self, format: str, evidence: Dict) -> int:
        ...
        if format == 'multi_part':
            ...
            has_high_level = any('VOLUME' in str(e) or 'PART' in str(e) or 'BOOK' in str(e) 
    ...
    def _get_recommendations(self, format: BookFormat, confidence: float, 
