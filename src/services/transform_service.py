...
from src.models.transformation import (
    Transformation, TransformType, TransformationChange, TransformationResult
)
from src.strategies.transform import TransformStrategy, SmartTransformStrategy
...
class TransformService(BaseService):
    ...
    async def process_async(self, 
                          data: Dict[str, Any]) -> Transformation:
        """
    ...
    async def transform_book_async(self,
                                  ...
                                  characters: Optional[CharacterAnalysis] = None) -> Transformation:
        """
    ...
    def _create_context(self, 
                       ...
                       transform_type: TransformType) -> Dict[str, Any]:
        """
        Create transformation context.
        ...
        if transform_type == TransformType.ALL_MALE:
            return {
                ...
                'terms': {
                    ...
                    'wife': 'husband', 'queen': 'king', 'lady': 'lord'
                }
            }
            ...
            return {
                ...
                'terms': {
                    ...
                    'husband': 'wife', 'king': 'queen', 'lord': 'lady'
                }
            }
    ...
    async def _transform_chapters_async(self,
                                       chapters: List[Chapter],
                                       context: Dict[str, Any]) -> tuple[List[Chapter], List[TransformationChange]]:
        """
    ...
    async def _transform_chapters_sequential(self,
                                            chapters: List[Chapter],
                                            context: Dict[str, Any]) -> tuple[List[Chapter], List[TransformationChange]]:
    ...
    async def _transform_chapters_parallel(self,
                                          chapters: List[Chapter],
                                          context: Dict[str, Any]) -> tuple[List[Chapter], List[TransformationChange]]:
    ...
    async def _transform_single_chapter(self,
                                       chapter: Chapter,
                                       chapter_index: int,
                                       context: Dict[str, Any]) -> tuple[Chapter, List[TransformationChange]]:
        """
